...
# ADD CPP /nologo /MD /W4 /WX /O2 /I "../../sim" /I "$(QTDIR)\include" /I "..\..\sim" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "QT_DLL" /D "MY__homedir_EXPORTS" /D VERSION=\"0.9.4\" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib $(QTDIR)\lib\qt-mt230nc.lib ..\..\Release\sim.lib /nologo /dll /pdb:none /machine:I386
...
# ADD CPP /nologo /MDd /W4 /WX /Gm /ZI /Od /I "..\..\sim" /I "$(QTDIR)\include" /I "..\..\sim" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "QT_DLL" /D "UNICODE" /D "QT_THREAD_SUPPORT" /D VERSION=\"0.9.4\" /D PACKAGE=\"SIM\" /D USE_QT=1 /D "DEBUG" /FR /FD /GZ /c
