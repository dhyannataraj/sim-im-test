...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib winmm.lib $(QTDIR)\lib\$(QTLIB) ..\..\Release\sim.lib /nologo /dll /pdb:none /machine:I386 /out:"../../Release/plugins/filter.dll"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\_core" /I "$(QTDIR)\include" /I "..\..\sim" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "QT_DLL" /D "UNICODE" /D "QT_THREAD_SUPPORT" /D VERSION=\"0.9.5 $(SIMTAG)\" /D PACKAGE=\"SIM\" /D USE_QT=1 /D "DEBUG" /FR /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib winmm.lib $(QTDIR)\lib\$(QTLIB) ..\..\Debug\sim.lib /nologo /dll /debug /machine:I386 /out:"../../Debug/plugins/filter.dll" /pdbtype:sept
