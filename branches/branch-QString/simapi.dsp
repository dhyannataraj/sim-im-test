...
# ADD CPP /nologo /MD /W4 /O1 /I "$(QTDIR)\include" /I "sim" /I "sim" /I "sim\api\win32" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "SIMAPI_EXPORTS" /D "QT_DLL" /D "UNICODE" /D "USE_OPENSSL" /D LTDL_SHLIB_EXT=\".dll\" /D LTDL_OBJDIR=\"\" /D "HAVE_STDIO_H" /D "HAVE_STRING_H" /D "HAVE_MALLOC_H" /D VERSION=\"0.9.5 $(SIMTAG)\" /D PACKAGE=\"SIM\" /YX /FD /c
