...
;
; *** Inno Setup version 4.0.2 Bulgarian messages ***
...
SelectDirLabel=Изберете папката, в която да се инсталира [name], и натиснете "Напред":
...
SelectStartMenuFolderLabel=Изберете папката в менюто Start, където искате да бъдат поставени иконите на програмата, и натиснете "Напред".
...
SelectDirectory=Избор на директория
