...
# ADD LINK32 ..\..\Release\simui.lib wsock32.lib winmm.lib $(LIBXSLT_DIR)\libxslt.lib $(LIBXML_DIR)\libxml2.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib $(QTDIR)\lib\$(QT_LIB) ..\..\Release\simapi.lib /nologo /dll /pdb:none /machine:I386 /out:"../../Release/plugins/_core.dll"
