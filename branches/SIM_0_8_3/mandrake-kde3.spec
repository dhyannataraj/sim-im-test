...
KDEDIR=/opt/kde3  QTDIR=/usr/lib/qt3  PATH=$KDEDIR/bin:$QTDIR/bin:$PATH CFLAGS="$RPM_OPT_FLAGS" CXXFLAGS="$RPM_OPT_FLAGS" ./configure $LOCALFLAGS --with-qt-includes=/usr/lib/qt3/include --with-qt-libs=/usr/lib/qt3/lib
