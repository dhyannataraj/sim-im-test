; *** Inno Setup version 4.0.5+ Ukrainian messages ***
;
...
;
; *** Updated from version 3.0.2 to version 3.0.5 to version 4.0.5
; *** by Roman Kovbasiouk, roman@elsyst.km.ua
;
...
SelectDirLabel=Виберіть каталог, в який Ви бажаєте проінсталювати програму "[name]", потім натисніть "Далі".
DiskSpaceMBLabel=Програма потребує щонайменше [mb] Мб вільного дискового простору.
...
BadDirName32=Назва каталогу не може містити наступних символів:%n%n%1
DirExistsTitle=Каталог вже існує
DirExists=Каталог:%n%n%1%n%nвже існує. Проінсталювати в нього?
DirDoesntExistTitle=Каталог не існує
DirDoesntExist=Каталог:%n%n%1%n%nне існує. Створити?
...
SelectStartMenuFolderLabel=Виберіть каталог в меню "Пуск", у якому інсталяційна програма створить значки, потім натисніть "Далі".
...
ReadyMemoDir=Каталог інсталяції:
...
SelectDirectory=Виберіть каталог
