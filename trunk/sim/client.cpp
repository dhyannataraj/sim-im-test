...
cfgParam ICQClient_Params[] =
    {
        ...
        { "ChatAvaliable", OFFSET_OF(ICQClient, ChatAvailable), PARAM_BOOL, 0 },
        { "ChatGroup", OFFSET_OF(ICQClient, ChatGroup), PARAM_USHORT, 1 },
        { "ChatTopic", OFFSET_OF(ICQClient, ChatTopic), PARAM_STRING, 0 },
        { "ChatName", OFFSET_OF(ICQClient, ChatName), PARAM_STRING, 0 },
        { "ChatAge", OFFSET_OF(ICQClient, ChatAge), PARAM_USHORT, 0 },
        { "ChatGender", OFFSET_OF(ICQClient, ChatGender), PARAM_CHAR, 0 },
        { "ChatLanguage", OFFSET_OF(ICQClient, ChatLanguage), PARAM_USHORT, 0 },
        { "ChatCountry", OFFSET_OF(ICQClient, ChatCountry), PARAM_USHORT, 0 },
        { "ChatHomepage", OFFSET_OF(ICQClient, ChatHomepage), PARAM_STRING, 0 },
