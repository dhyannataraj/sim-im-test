                    ...
                    QIconSet *bgIcon, const QPixmap &dllIcon)
{
    ...
    if (!dllIcon.isNull()){
        ...
        if (isSystem){
            ...
            pict.setPixmap(bigIcon.pixmap(QIconSet::Large, QIconSet::Normal), QIconSet::Large);
            pict.setPixmap(bigIcon.pixmap(QIconSet::Large, QIconSet::Active), QIconSet::Large, QIconSet::Active);
        }
#else
        isSystem = false;
#endif
