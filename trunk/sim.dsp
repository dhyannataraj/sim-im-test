...
# ADD CPP /nologo /MD /W3 /O1 /I "$(QTDIR)\include" /I "sim" /I "sim\libicq" /I "sim\qt3" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "QT_DLL" /D "UNICODE" /D "QT_THREAD_SUPPORT" /D "NO_DEBUG" /D PACKAGE=\"SIM\" /D VERSION=\"0.7\" /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib $(QTDIR)\lib\qt-mt230nc.lib $(QTDIR)\lib\qtmain.lib idle\Release\idletrac.lib winmm.lib /nologo /subsystem:windows /machine:I386
...
# ADD CPP /nologo /MD /W3 /Gm /ZI /Od /I "$(QTDIR)\include" /I "sim" /I "sim\libicq" /I "sim\qt3" /I "\openssl\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "QT_DLL" /D "UNICODE" /D "QT_THREAD_SUPPORT" /D VERSION=\"0.7\" /D PACKAGE=\"SIM\" /D USE_OPENSSL=1 /FR /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib winmm.lib $(QTDIR)\lib\qt-mt230nc.lib $(QTDIR)\lib\qtmain.lib idle\Release\idletrac.lib \openssl\lib\ssleay32.lib \openssl\lib\libeay32.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept
...
SOURCE=.\sim\ui\finddlg.cpp
# End Source File
# Begin Source File

SOURCE=.\sim\ui\finddlgbase.cpp
# End Source File
# Begin Source File
...
SOURCE=.\sim\ui\moc_finddlg.cpp
# End Source File
# Begin Source File

SOURCE=.\sim\ui\moc_finddlgbase.cpp
# End Source File
# Begin Source File
...
# Begin Custom Build - Uic'ing $(InputName).ui ...
InputDir=.\sim\ui
InputPath=.\sim\ui\finddlgbase.ui
InputName=finddlgbase
...
"$(OutDir)\pu.qm" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	$(QTDIR)\bin\msg2qm $(InputPath) 
