        ...
        : QWidget( parent)
{
    ...
    btnAuth1->setIcon(getIcon("text_strike"));
    btnAuth2->setIcon(getIcon("text_italic"));
    btnAuth3->setIcon(getIcon("text_under"));
    btnVisible1->setIcon(getIcon("text_strike"));
    btnVisible2->setIcon(getIcon("text_italic"));
    btnVisible3->setIcon(getIcon("text_under"));
    btnInvisible1->setIcon(getIcon("text_strike"));
    btnInvisible2->setIcon(getIcon("text_italic"));
    btnInvisible3->setIcon(getIcon("text_under"));
